...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['num_questions_select'])) {
        ...
        header('Location: question.php'); // Redirect to question.php to start quiz
        exit();
    }
                    ...
                    <td style="width:1000px;height:430px;background-image:url('./images/NO.jpg');background-repeat:no-repeat;">
                        <center>
                            ...
                            <?php if ($_SESSION['num_questions_total'] > 0): ?>
                                <h2>Vous avez sélectionné <?php echo $_SESSION['num_questions_total']; ?> calculs.</h2>
                                <a href=".\question.php"><input type="submit" value="Commencer le Quiz"></a>
                            <?php endif; ?>
