                        ...
                        <?php if ($loggedInUser): ?>
                            ...
                            <?php if ($loggedInUser['role'] == 'Enfant'): ?>
								...
								<?php elseif ($loggedInUser['role'] == 'Professeur(e)'): ?>
									<p>Gérer les exercices et les données des élèves</p>
									<a href="addition/addition_settings.php" class="btn btn-primary">Paramètres des additions</a> <br /><br />
									<a href="views/stats.php" class="btn btn-primary">Voir les statistiques des élèves</a> <?php // Ligne ajoutée pour les profs ?>
