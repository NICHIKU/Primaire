...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['num_questions_select'])) {
        ...
        header('Location: question.php'); // Redirect to question_subtraction.php to start quiz
        exit();
    }
...
<html lang="fr">
    <head>
        <meta charset="utf-8">
        <title>Accueil - Soustractions</title>
    </head>
                    ...
                    <td style="width:1000px;height:430px;background-image:url('./images/NO.jpg');background-repeat:no-repeat;">
                        <center>
                            ...
                            <?php if ($_SESSION['num_questions_total'] > 0): ?>
                                <h2>Vous avez sélectionné <?php echo $_SESSION['num_questions_total']; ?> calculs de soustractions.</h2>
                                <a href=".\question.php"><input type="submit" value="Commencer le Quiz de Soustractions"></a>
                            <?php endif; ?>
